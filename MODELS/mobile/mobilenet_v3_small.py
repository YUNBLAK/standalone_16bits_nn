...
from MODELS.mobile.mobilenet_base import MobileNetBase
...
class MobileNetV3_Small(MobileNetBase):
    ...
    def build(self, shape, plot=False):
        ...
        x = tf.keras.layers.Lambda(lambda image: tf.image.resize(image, shape))(inputs)
